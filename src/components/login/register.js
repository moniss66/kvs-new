...
const Register = () => {
    ...
    function handleAddrTypeChange(e) {
      ...
      const onSignup = async(e) =>{
        ...
        try {
            ...
            alert("Fill details properly"+response.toString());
    ...
    return (
        <div class="flex form justify-center mt-5">
  ...
  onChange={handleAddrTypeChange}  required >
                ...
                <br />
                <div class="w-full  justify-center px-3 md:mb-0 ">
                    <button class="add-button hover:bg-blue-700 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" onClick={onSignup} >
                        Register
                    </button>
