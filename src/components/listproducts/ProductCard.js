  ...
  return (
    <div className='rounded-2xl overflow-hidden  shadow-xl tranform hover:scale-110 duration-100'>
      ...
      <div className='flex flex-col items-center my-2 py-2'>
        ...
        <button className='bg-cyan-500  hover:bg-cyan-400 hover:text-black text-green font-bold py-2 px-4 my-3 rounded-full font-mono text-lg add-button' onClick={()=>updateModelShow(!modelShow)}>Add to Cart </button>
      </div>
      <>
            <Modal
              show={modelShow}
